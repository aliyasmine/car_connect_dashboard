  ...
  return ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderSide: const BorderSide(color: AppColorManager.navy),
        borderRadius: BorderRadius.circular(AppRadiusManager.r10),
      ),
    ...
    //   ),
    // ),
    colorScheme: const ColorScheme.light(primary: AppColorManager.navy)
        .copyWith(secondary: AppColorManager.navy),
